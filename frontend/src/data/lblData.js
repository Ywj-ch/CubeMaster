...
export const lblSteps = [
    ...
    cases: [
      {
        ...
        title: "角块在顶层，黄色朝前",
        description:
          "黄色角块位于顶层，且黄色面朝前，并且左侧面或者是右边侧面与该侧面中心颜色相同，",
  ...
  },
  {
    ...
    title: "第五步：顶层全白",
    description:
      "使用小鱼公式调整顶层角块方向，使整个顶面变为白色。此时角块位置可能还不正确。",
    cases: [
      {
        id: "case-5-1",
        ...
        setup:
          "B2 D F2 R2 B2 U2 L2 U' L2 U' F' U B' R2 U B U F' U2 R U R' U R U2 R' U",
  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        setup:
          "R U R' U' R' F R2 U' R' U' R U R' F' R R D R' R' D' F F R' R' U' R R U F' F'",
        algorithm: "R R D R' R' D' F F R' R' U' R R U F' F'",
